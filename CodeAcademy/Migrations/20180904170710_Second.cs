        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LessonsStartDate = table.Column<DateTime>(nullable: false),
                    LessonsEndDate = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Groups_CourseCompletionStatuses_CourseCompletionStatusId",
                        column: x => x.CourseCompletionStatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageCount = table.Column<short>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Faculties_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SocialProfiles_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Faculties_ImageId",
                table: "Faculties",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_Groups_CourseCompletionStatusId",
                table: "Groups",
                column: "CourseCompletionStatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SocialProfiles_ImageId",
